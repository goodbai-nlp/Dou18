...
def get_candidates(emb1, emb2, params):
    ...
    # contextual dissimilarity measure
        ...
        average_dist1 = torch.from_numpy(get_nn_avg_dist(emb2, emb1, knn, params.cuda_device))
        average_dist2 = torch.from_numpy(get_nn_avg_dist(emb1, emb2, knn, params.cuda_device))
...
# def get_nn_avg_dist(emb, query, knn, device_id):
#     """
